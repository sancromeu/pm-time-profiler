...
/**
 * Get a JLogger-based time profiler.
 *
 * @author sancromeu
*/
public final class ProfilerJLogger {

    /**
     * Create JLogger-based profiler using current configuration
    ...
    /**
     * Create JLogger-based profiler using current configuration. Prepend message with given label.
     * @param logger logger to log time events
     * @param level minimum logging level to track and log time
    ...
    /**
     * Create JLogger-based profiler using current configuration but use given tracker this once.
     * @param logger logger to log time events
     * @param level minimum logging level to track and log time
    ...
    /**
     * Create JLogger-based profiler using current configuration but use given message builder this once.
     * Prepend message with given label.
     * @param logger logger to log time events
     * @param level minimum logging level to track and log time
    ...
    /**
     * Create JLogger-based profiler using current configuration but use given tracker and message builder this once.
     * @param logger logger to log time events
     * @param level minimum logging level to track and log time
     * @param trackerType use this tracker instead of the globally configured one just this once
     * @param messageBuilder use this message builder this once (it is more efficient to configure a
